# Morning Research Workbench | 2026-08-15
...
_Data through: global `2026-08-14` | HK/China `2026-08-14` | Market effective `2026-08-14` | Generated `2026-08-15 05:40:07`_

## Executive Summary

- **Market pulse:** Risk-On backdrop with USD softer, higher yields pressured valuations, and Gold outperformed Bitcoin
- **Hong Kong lens:** Selective growth leadership: 3033.HK moved +0.47% and beat HSCEI by +0.70pp and HSI by +0.64pp. Conviction is limited because Southbound recorded -HK$1.3bn net selling. Favor relative strength in internet/platform names, but do not treat the move as broad China risk-on until participation confirms.
...
![Research Dashboard](charts/dashboard_2026-08-15.png)

**Catalyst & Event Radar**

![Catalyst & Event Radar](charts/catalyst_radar_2026-08-15.png)
...
| Hang Seng Index | 25,396.51 / -0.17% | Hong Kong broad beta weakened and needs offshore or policy support to stabilize. | Confirm with Southbound participation and breadth; invalidate if USD/CNH weakens while turnover fades. |
...
| DXY | 99.64 / -0.32% | A softer dollar eases an external-liquidity headwind for Hong Kong risk assets. CNH did not confirm the relief, so the liquidity signal is incomplete. | Confirm with USD/CNH moving in the same risk direction; divergence reduces conviction. |
...
| AH premium index | 33.38% | Live public | Yahoo \| 2026-08-14 | Simple average across 18 A/H pairs; use dispersion rather than the average alone. |
...
### 1.4 Decision Board
**Composite risk score:** `60.2/100` | **Regime:** `Mixed`
...
1. **Risk-On backdrop with USD softer, higher yields pressured valuations, and Gold outperformed Bitcoin**
...
**Market Setup**
**Core tape.** Risk-On backdrop with USD softer, higher yields pressured valuations, and Gold outperformed Bitcoin

**Hong Kong Read-Through**
**Desk lens.** Selective growth leadership.
**Evidence.** 3033.HK moved +0.47% and beat HSCEI by +0.70pp and HSI by +0.64pp
...
- **Cross-market read:** Hang Seng -0.17% / HSCEI -0.23% / 3033.HK ETF +0.47%.
...
- The biggest cross-asset divergence was Gold versus Bitcoin, a spread of 2.157pct.
- Gold moved +1.22pct intraday with a 1.859pct high-low range.


**Curated overnight stories**
1. **Uber partners with China's Pony.ai for 2,000 robotaxis in Europe**
 Why it matters: First major overseas commercial scale-up for a Chinese autonomous-driving platform with a global ride-hailing operator, directly tying a Chinese AV name to.
 HK read-through: Most relevant single story for Hong Kong tech, EV and smart-driving names, and for sentiment on Chinese AV export readiness.
2. **Goldman's latest cash cow is all about funding the AI infrastructure boom**
 Why it matters: Signals that AI capex demand is driving fresh Wall Street revenue streams (financing/funding), reinforcing the AI infrastructure cycle narrative rather than fading it.
 HK read-through: Supports the AI/semiconductor and infrastructure capex tailwind that HK-listed chip and hardware names have been riding, though 'higher yields pressured valuations' note in.
3. **'Big Short' investor Steve Eisman sees an Achilles' heel in the AI boom**
 Why it matters: A credible bearish counter-narrative on the AI capex cycle from a well-known investor; useful as a risk frame rather than a directional signal.
 HK read-through: Indirect: limits the upside multiple HK investors are willing to pay for AI-exposed names and increases the chance of sharper pullbacks on negative AI headlines.
4. **Berkshire Hathaway boosts Alphabet to a top three holding, ups Delta and housing bets**
 Why it matters: A high-profile long-only institution re-anchoring conviction in a US mega-cap AI leader; Delta and housing bets broaden the read on US cyclical risk appetite.
 HK read-through: Indirect read-through for HK AI/internet sentiment and for travel-leisure names (Delta exposure can colour views on HK-listed travel and Macau-related names).
5. **These charts show why stocks keep rallying. Profit margins are the highest on record**
 Why it matters: Macro framing: explains why the equity rally can persist despite the must-watch note that 'higher yields pressured valuations'; earnings power is doing the heavy lifting.
 HK read-through: Sets the backdrop for HK earnings revisions: supportive for quality HK names with margin expansion, but raises the bar if margin peaks.
...
| --- | --- | --- | --- | --- |
| Oil and geopolitics | mixed | 1.4 | Oil moved +1.75%. | Split the read between energy/cyclicals support and margin/geopolitical pressure. |
...
| Dollar / CNH pressure | supportive | 0.48 | DXY -0.32% / USD-CNH +0.00% | A stable or softer CNH makes Hong Kong follow-through more credible. |
...
- AH premium: simple covered-pair average +33.38%; widest premium: China Communications Construction 102.79%.
...
| --- | --- | --- | --- | --- |
| China Communications Construction | 601800.SS | 1800.HK | +102.79% | 2026-08-14 |
| China Life | 601628.SS | 2628.HK | +59.83% | 2026-08-14 |
| China Railway Construction | 601186.SS | 1186.HK | +56.15% | 2026-08-14 |
| China Railway | 601390.SS | 0390.HK | +49.10% | 2026-08-14 |
| CRRC | 601766.SS | 1766.HK | +38.39% | 2026-08-14 |
...
<div class="company-event-monitor">
<div class="event-monitor-summary">
<div class="event-summary-copy"><span class="event-kicker">Decision filter</span><h4>No immediate portfolio catalyst: 20 official filings were screened and the low-signal market set stays aggregated.</h4><p>20 profit warnings</p></div>
<div class="event-stats" aria-label="Company event summary">
<div><strong>20</strong><span>Official filings</span></div>
<div><strong>0</strong><span>Watchlist hits</span></div>
<div><strong>0</strong><span>Actionable events</span></div>
</div>
</div>
<div class="event-card-list"><div class="event-monitor-empty">
...
<p class="event-coverage-note"><strong>Coverage boundary.</strong> Earnings calendar, sell-side rating changes, IPO / grey-market monitor were not decision-grade in this run; their absence is not treated as confirmation that no event exists.</p>
</div>
...
**Theme desk read**
**Core thesis.** The AI and Compute Chain theme carries into today with mixed signals that the desk should weigh rather than ignore.
**Evidence.** The overnight tape is labelled Risk-On with USD softer, but the US 10Y is +5.5bp.
**What to test.** Tencent (0700.HK, -0.23%) was the most direct theme data point: revenue was called resilient while quarterly capex rose 176% and pushed free cash flow below zero per the cited report.

**Signals to keep in mind**
- VIX -2.60%: Lower volatility signals easing stress in the tape.
- Gold +1.57%: A firm gold price suggests hedge demand or lower real yields.

**LLM watch items:**
- Follow-up on the Tencent AI capex / FCF story: whether management messaging in the next session reframes the 176% capex jump as front-loaded or
- Alibaba cloud demand and GMV updates - confirm whether 9988.HK's -1.64% was positioning-driven or an early read on the compute chain.
- US 10Y reaction at the open (last 4.696%, +5.5bp) - any further yield backup would tighten the noose on long-duration AI names regardless of a
- China Mobile capex and dividend signals as the defensive offset within the AI/digital-infrastructure basket.
- Bitcoin vs. Gold split (Gold +1.57%, BTC -0.92%) for a second consecutive session - useful as a sentiment sanity check on whether the Risk-On label
...
![Daily One Chart](charts/daily_one_chart_2026-08-15.png)
...
### Report Metadata
> Date policy: Review date 2026-08-14 is treated as `Trading Daily`. | Global request date is 2026-08-14; adapter effective date is 2026-08-14 and summary date is 2026-08-14. | HK/China local data date is 2026-08-14; role: same-session local cash tape.
...
| Narrative overlay health | 35.7 | 0.1 | 1/7 narrative overlay tasks succeeded or used validated cache; 3 error(s). |
...
| --- | --- | --- | --- | --- | --- | --- |
| Hang Seng Index | 56 | 1.0% | -3.8% | 4.7% | -7.9% | 48.1% |
...
![Published signal performance](charts/signal_performance_2026-08-15.png)
...
### Source Links
- [JD.com Profit Beats Estimates After Food Delivery Fight Calms](https://finance.yahoo.com/markets/stocks/articles/jd-com-profit-beats-estimates-100519514.html) (Bloomberg)
- [Tencent Stock Slips Again as AI Spending Outruns Profit Growth](https://finance.yahoo.com/technology/ai/articles/tencent-stock-slips-again-ai-191931585.html) (GuruFocus.com)
...
| Visual | Path | Role |
| --- | --- | --- |
| Visual Dashboard | `charts/dashboard_2026-08-15.png` | Cross-asset regime board and Hong Kong local tape snapshot. |
| Catalyst & Event Radar | `charts/catalyst_radar_2026-08-15.png` | Confirmed dates, time windows, undated monitors, and recent issuer read-through. |
| Daily One Chart | `charts/daily_one_chart_2026-08-15.png` | Single highest-conviction visual story for the day. |
...
- Cross-asset: The biggest cross-asset divergence was Gold versus Bitcoin, a spread of 2.157pct.
- Cross-asset: Gold moved +1.22pct intraday with a 1.859pct high-low range.
- Cross-asset: Oil moved +1.17pct intraday with a 2.627pct high-low range.
- Cross-asset: Bitcoin moved -0.94pct intraday with a 1.624pct high-low range.
